...
# SRAM binary load
#Working
#insmod inffmac.ko debug=0x0
#insmod inffmac.ko
#insmod inffmac.ko debug=0x0 fcmode=2 auto_kso_disable=1
#insmod inffmac.ko debug=0x0x2edFFDF fcmode=2 auto_kso_disable=1
#insmod inffmac.ko debug=0x2edFFDF fcmode=2 auto_kso_disable=1
#sleep 10
#ifconfig wlan0 192.168.50.20 up
#sleep 2
#wl wd_disable 1
##sleep 2
#wl mpc 0
...
# RRAM binary load
#Working
insmod inffmac.ko debug=0xFFFFFF inff_ram_app_logic_path="/root/TC1_ES10_1/cyapp_rram_wifiss_fw_update_pkg.bin" inff_ram_app_payload_path="/root/TC1_ES10_1/rtecdc_rram_Naveen_mend.trxse"
