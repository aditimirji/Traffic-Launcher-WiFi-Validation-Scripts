...
wl mpc 0
wl up
ifconfig wlan0 192.168.50.25 up
#sleep 2
#wl wd_disable 1
##sleep 2
#wl mpc 0
...
# RRAM binary load
#Working
#insmod inffmac.ko debug=0xFFFFFF inff_ram_app_logic_path="/root/RC2_ES10_1/cyapp_rram_wifiss_fw_update_pkg.bin" inff_ram_app_payload_path="/root/RC2_ES10_1/rtecdc_rram_tob_fix.trxse"
